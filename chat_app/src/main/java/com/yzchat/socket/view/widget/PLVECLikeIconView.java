...
import com.yzchat.socket.utils.PLVBezierEvaluator;
...
public class PLVECLikeIconView extends RelativeLayout {
    ...
    private void initChild() {
        ...
        float d = ScreenUtils.dip2px(getContext(),32);
        ...
        bgLp.bottomMargin = ScreenUtils.dip2px(getContext(), 3);
        bgLp.rightMargin = ScreenUtils.dip2px(getContext(), 6);
    ...
    private void startAnimator(ImageView view) {
        ...
        PointF pointF1 = new PointF(
                random.nextInt(Math.max(2, width -  ScreenUtils.dip2px(getContext(),16))),
        ...
        PointF pointEnd = new PointF(random.nextInt(Math.max(2, width -  ScreenUtils.dip2px(getContext(),16))), 0);
