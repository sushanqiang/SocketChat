package com.yzchat.socket.view.widget.messages;
...
public class MessageHolders {
    ...
    protected int getViewType(Object item, String senderId) {
        ...
        if (item instanceof IMessage) {
            ...
            Log.e("getViewType","message.getUser().getId()="+message.getUser().getId());

        } else viewType = VIEW_TYPE_DATE_HEADER;
        Log.e("getViewType","-isOutcoming="+isOutcoming+"  viewType="+viewType+"  senderId="+senderId);
